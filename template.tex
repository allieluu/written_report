...
% TODO: Say more about Alzheimer's here.
...
\begin{table}[hbt]
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
    \end{tabular}
  % \caption{Formatting guidelines.} \label{table:formatting}
  \end{table}
...
% \centering
% \includegraphics[width=.75\textwidth]{checkerboard-squares-black-white.jpg}
...
% \begin{minipage}[b]{0.5\textwidth}
% \centering
% \includegraphics[width=.75\textwidth]{swirl-squares-black-white.jpg}
